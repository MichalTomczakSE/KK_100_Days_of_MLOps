...
Solutions and walkthroughs for the [KodeKloud 100 Days of MLOps](https://kodekloud.com) challenge.

Each day's folder contains a `README.md` with the task description, a step-by-step solution, and any supporting code files.
...
| [Day 12](days/day-12-dvc-remote-storage/) | Configure a DVC Remote Storage | ✅ |
...
| [Day 17](days/day-17-dvc-experiments/) | Run and Compare DVC Experiments | ✅ |
...
| Days | Topic |
|------|-------|
| 1–9 | Environment setup & project tooling |
| 10–19 | Data versioning with DVC |
| 20–30 | Experiment tracking with MLflow |
| 31–40 | Model training at scale |
| 41–49 | Feature stores, secrets & data quality |
| 50–66 | Docker & model serving |
| 67–75 | Monitoring with Prometheus, Grafana & Evidently |
| 76–84 | CI/CD for ML |
| 85–91 | Workflow orchestration (Argo, Prefect) |
| 92–100 | Kubernetes & capstone |
